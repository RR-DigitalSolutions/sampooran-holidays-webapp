...
router.get("/:slug", cacheMiddleware(180), async (req: Request, res: Response) => {
  try {
    ...
    const [hotel] = await db
      .select({
        // Keep the public detail contract explicit. Selecting the whole table
        // made this endpoint fail when a newer optional hotel column was not
        // yet present in the production database.
        hotel: {
          id: hotelsTable.id,
          ownerId: hotelsTable.ownerId,
          destinationId: hotelsTable.destinationId,
          stateId: hotelsTable.stateId,
          countryId: hotelsTable.countryId,
          destinationSlug: hotelsTable.destinationSlug,
          stateSlug: hotelsTable.stateSlug,
          countrySlug: hotelsTable.countrySlug,
          ...
          email: hotelsTable.email,
          website: hotelsTable.website,
          latitude: hotelsTable.latitude,
          longitude: hotelsTable.longitude,
          proximity: hotelsTable.proximity,
          faqs: hotelsTable.faqs,
          amenities: hotelsTable.amenities,
          highlights: hotelsTable.highlights,
          images: hotelsTable.images,
          minPrice: hotelsTable.minPrice,
          bookingType: hotelsTable.bookingType,
          checkInTime: hotelsTable.checkInTime,
          checkOutTime: hotelsTable.checkOutTime,
          breakfastIncluded: hotelsTable.breakfastIncluded,
          status: hotelsTable.status,
          isFeatured: hotelsTable.isFeatured,
          showOnFrontend: hotelsTable.showOnFrontend,
          metaTitle: hotelsTable.metaTitle,
          metaDescription: hotelsTable.metaDescription,
        },
        destinationName: destinationsTable.name,
