...
var BASE = "http://localhost:8080/api/admin";
function login() {
    return __awaiter(this, void 0, void 0, function () {
        var res, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetch("".concat(BASE, "/auth/login"), {
                        method: "POST",
            ...
            switch (_c.label) {
                ...
                case 2:
                    ...
                    try {
                        ...
                        throw new Error("Failed to parse JSON for ".concat(path, ". Status: ").concat(res.status, ". Body: ").concat(text.substring(0, 500)));
                    }
                    if (!res.ok) {
                        if (((_a = data.error) === null || _a === void 0 ? void 0 : _a.includes("unique")) || ((_b = data.error) === null || _b === void 0 ? void 0 : _b.includes("duplicate"))) {
                            console.log("  \u2139\uFE0F  Already exists, skipping: ".concat(path));
                            return [2 /*return*/, null];
                        }
                        throw new Error("POST ".concat(path, " failed: ").concat(JSON.stringify(data)));
                    }
...
function seed() {
    return __awaiter(this, void 0, void 0, function () {
        var token, india, hp, kashmir, ladakh, rajasthan, manali, gulmarg, leh, jaipur, pkg;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    // ─── COUNTRIES ────────────────────────────────────────────────────────────────
                    console.log("\n📍 Seeding Countries...");
                    return [4 /*yield*/, post(token, "/countries", {
                ...
                case 2:
                    india = _a.sent();
                    console.log("  ✅ India:", (india === null || india === void 0 ? void 0 : india.id) || "skipped");
                    // ─── STATES ───────────────────────────────────────────────────────────────────
                    console.log("\n🗺️  Seeding States...");
                    if (!(india === null || india === void 0 ? void 0 : india.id)) {
                        console.log("  ⚠️  Skipping states — India not created. Run again after clearing duplicates.");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, post(token, "/states", {
                ...
                case 3:
                    hp = _a.sent();
                    console.log("  ✅ Himachal Pradesh:", (hp === null || hp === void 0 ? void 0 : hp.id) || "skipped");
                    return [4 /*yield*/, post(token, "/states", {
                ...
                case 4:
                    kashmir = _a.sent();
                    console.log("  ✅ Jammu & Kashmir:", (kashmir === null || kashmir === void 0 ? void 0 : kashmir.id) || "skipped");
                    return [4 /*yield*/, post(token, "/states", {
                ...
                case 5:
                    ladakh = _a.sent();
                    console.log("  ✅ Ladakh:", (ladakh === null || ladakh === void 0 ? void 0 : ladakh.id) || "skipped");
                    return [4 /*yield*/, post(token, "/states", {
                ...
                case 6:
                    rajasthan = _a.sent();
                    console.log("  ✅ Rajasthan:", (rajasthan === null || rajasthan === void 0 ? void 0 : rajasthan.id) || "skipped");
                    // ─── DESTINATIONS / PLACES ────────────────────────────────────────────────────
                    console.log("\n🏔️  Seeding Destinations/Places...");
                    return [4 /*yield*/, post(token, "/destinations", {
                ...
                case 7:
                    manali = _a.sent();
                    console.log("  ✅ Manali:", (manali === null || manali === void 0 ? void 0 : manali.id) || "skipped");
                    return [4 /*yield*/, post(token, "/destinations", {
                ...
                case 8:
                    gulmarg = _a.sent();
                    console.log("  ✅ Gulmarg:", (gulmarg === null || gulmarg === void 0 ? void 0 : gulmarg.id) || "skipped");
                    return [4 /*yield*/, post(token, "/destinations", {
                ...
                case 9:
                    leh = _a.sent();
                    console.log("  ✅ Leh:", (leh === null || leh === void 0 ? void 0 : leh.id) || "skipped");
                    return [4 /*yield*/, post(token, "/destinations", {
                ...
                case 10:
                    jaipur = _a.sent();
                    console.log("  ✅ Jaipur:", (jaipur === null || jaipur === void 0 ? void 0 : jaipur.id) || "skipped");
                    // ─── PACKAGE ──────────────────────────────────────────────────────────────────
                    console.log("\n📦 Seeding Professional Package...");
                    if (!(manali === null || manali === void 0 ? void 0 : manali.id)) {
                        console.log("  ⚠️  Skipping package — Manali destination not found.");
                        return [2 /*return*/];
                    }
                    return [4 /*yield*/, post(token, "/packages", {
                ...
                case 11:
                    pkg = _a.sent();
                    console.log("  ✅ Package 'Manali Honeymoon Special':", (pkg === null || pkg === void 0 ? void 0 : pkg.id) || "skipped");
                    console.log("\n🎉 Seeding Complete!");
