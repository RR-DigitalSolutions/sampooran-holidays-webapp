...
const filePath = path.join(__dirname, '..', 'frontend', 'src', 'components', 'pages', 'PackageDetailsPage.tsx');
              ...
              <div className="lg:col-span-4">
                <div className="rounded-[32px] border border-white/15 bg-white/95 backdrop-blur-xl shadow-2xl shadow-slate-950/10 p-6 lg:p-8 text-slate-900">
                  ...
                  <div className="space-y-3">
                    ...
                    <a href={
                      `https://wa.me/919000000000?text=I’m interested in ${packageData.name}`
                    } target="_blank" rel="noreferrer" className="block w-full border border-slate-200 text-slate-900 text-center py-3 rounded-2xl font-semibold hover:bg-slate-50 transition">
                      Enquire on WhatsApp
                    </a>
                  </div>
                ...
                {galleryImages.slice(0, 3).map((image, idx) => (
                  <div key={idx} className="relative rounded-[28px] overflow-hidden aspect-[4/3] shadow-lg">
                    <Image
                      ...
                      alt={
                        `${packageData.name} gallery ${idx + 1}`
                      }
                      fill
            ...
            <div className="sticky top-28 space-y-6">
              <div className="rounded-[32px] bg-white border border-slate-200 p-6 shadow-sm">
                ...
                <div className="space-y-3">
                  ...
                  <a href={
                    `https://wa.me/919000000000?text=I’m interested in ${packageData.name}`
                  } target="_blank" rel="noreferrer" className="block w-full border border-slate-200 text-center py-3 rounded-2xl font-semibold text-slate-900 hover:bg-slate-50 transition">
                    Chat on WhatsApp
                  </a>
                </div>
              </div>
