                    ...
                    >
                      ...
                      <div className="flex-1 p-3 sm:p-4 flex justify-between items-start min-w-0">
                        <div className="min-w-0">
                          ...
                          {displayHighlights && displayHighlights.length > 0 && (
                            <div className="grid grid-cols-1 gap-0.5 mt-1.5">
                              {displayHighlights.map((h, i) => (
                                <div key={i} className="flex items-start gap-1.5 text-[8px] sm:text-[8.5px] text-slate-600 font-normal leading-tight">
                                  <div className="w-1 h-1 rounded-full bg-accent mt-1 shrink-0" />
                                  <span className="line-clamp-1">{h}</span>
                                </div>
                              ))}
