    ...
    <div className="min-h-screen bg-white font-sans">
        ...
        <div className="relative container mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-12">
          <div className="flex-1 max-w-xl">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/partner/register"
                className="flex items-center gap-2 bg-[#F5A623] hover:bg-amber-500 text-white font-black px-7 py-4 rounded-lg shadow-xl shadow-amber-500/30 transition-all hover:scale-105">
                Start for Free <ArrowRight className="w-5 h-5" />
              </Link>
              <Link href="/partner/login"
                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 border border-white/20 font-semibold px-7 py-4 rounded-lg transition-all">
          ...
          <div className="flex-1 grid grid-cols-2 gap-4 max-w-md w-full">
            {["Hotel", "Resort", "Cottage", "Homestay", "Villa", "Camp"].map((type, i) => (
              <div key={type}
                className="bg-white/10 backdrop-blur-md border border-white/20 rounded-lg p-4 flex items-center gap-3 hover:bg-white/20 transition-all cursor-default">
                <div className="w-10 h-10 bg-[#F5A623]/20 rounded-md flex items-center justify-center">
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {BENEFITS.map(b => (
              <div key={b.title} className="bg-white rounded-lg p-6 shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100">
                <div className={`w-14 h-14 bg-gradient-to-br ${b.color} rounded-md flex items-center justify-center mb-5 group-hover:scale-110 transition-transform`}>
            ...
            {STEPS.map((step, i) => (
              <div key={step.num} className="relative">
                ...
                <div className="relative z-10">
                  <div className="w-16 h-16 bg-gradient-to-br from-[#1B3A6B] to-[#0f2548] rounded-lg flex items-center justify-center mb-4 shadow-lg shadow-blue-900/20">
      ...
      <section className="py-20 bg-gradient-to-br from-[#0B1F4E] to-[#1B3A6B] text-white text-center">
        <div className="container mx-auto px-6 max-w-2xl">
          ...
          <Link href="/partner/register"
            className="inline-flex items-center gap-2 bg-[#F5A623] hover:bg-amber-500 text-white font-black px-10 py-4 rounded-lg shadow-xl transition-all hover:scale-105">
